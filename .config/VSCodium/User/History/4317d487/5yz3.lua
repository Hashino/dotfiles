...
--------------------------------------------------------------------------------------------------------------------------------------------
	...
	local update_margin = function(oute, innerr)

		outer.left	= #s.tags == 1 and 0 or outer_margin
		outer.right	= #s.tags == 1 and 0 or outer_margin
	end
--------------------------------------------------------------------------------------------------------------------------------------------
	...
	outer_margin = icon_taglist:get_children_by_id('outer_margin')[1]
	margin:connect_signal("taglist_changed", update_margin, outer_margin)
